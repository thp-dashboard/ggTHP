...
#'
#' @param palette Options are `brand1`, `semantic_gender`, `political2`, `sequential_blue`, `sequential_green`, `diverging`, `THP_categorical1`, `THP_categorical2`, and `THP_continuous_purple`
#'
#' @export
#'
#' @examples
